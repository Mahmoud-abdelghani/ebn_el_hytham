...
import 'package:ebn_el_hytham/core/utils/theme_data.dart';
...
class MaterialOfApp extends StatelessWidget {
  const MaterialOfApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        InstructorSalaryScreen.routeName: (context) => InstructorSalaryScreen(),
        InstructorResultScreen.routeName: (context) => InstructorResultScreen(),
